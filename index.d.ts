...
declare interface ClientPageData extends Omit<EndpointResponse, 'status'> {
    status: number;
    href: string;
    redirect?: string;
}
...
/** @public */
export declare const loadClientData: (url: URL, element: unknown, clearCache?: boolean, action?: RouteActionValue) => Promise<ClientPageData | undefined>;
...
/** @public */
export declare const removeClientDataCache: () => void;
...
/** @public */
export declare const RouterOutlet: Component<PropFunctionProps<    {
